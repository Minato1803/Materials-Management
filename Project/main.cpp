...
void danhSachBill(NODEPTR &tree, int &CountM);//1: Remove 2: Adjust
...
void taoMangBillDate(struct listEmp &ListEmployees, struct listBillDate *arr, struct Dates dayBegin, struct Dates dayEnd);
//==========MAIN====================================
int main()
{
	KhoiTaoChuongTrinh();
